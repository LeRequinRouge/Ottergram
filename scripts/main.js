...
function previousOtter() {
    'use strict';

    if (index > 0) {
        console.log("Previous otter: " + index);
...
function getIndex(thumb) {
    'use strict';

    for (var i = 0; i < 10; i++)
    {
        console.log("iterating...");
        if (thumbnails[i] == thumb)
        {
            var isElement = (element) => element == thumb;
            index = thumbnails.findIndex(isElement);
